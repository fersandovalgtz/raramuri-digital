...
Esta licencia se aplica a los conjuntos de datos, exportaciones lexicográficas, productos derivados y documentación producidos específicamente por el proyecto, salvo que un archivo indique expresamente otra condición.

This license applies to datasets, lexicographic exports, derived products, and documentation specifically produced by the project, unless a file expressly states otherwise.
...
The repository source code and software components are separately released under the [MIT License](LICENSE.md). The MIT License does not modify or expand the permissions applicable to data, documentation, cultural materials, or third-party content.
...
La disponibilidad de los datos no sustituye la autoridad lingüística, cultural o política de las comunidades y personas hablantes rarámuri. Toda reutilización debe atender también las disposiciones de [`GOVERNANCE.md`](GOVERNANCE.md), conservar la procedencia y evitar la apropiación o descontextualización.