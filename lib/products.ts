...
): Product => ({ id, slug, title, domain, objective, recordUnit, inputs, outputs, fields, dependencies, status: id === 1 ? "Operativo" : "Especificado" });
...
export const products: Product[] = [
  ...
  p(2, "corpus-digital-raramuri-espanol", "Corpus digital rarámuri-español", "Corpus", "Integrar todas las entradas y segmentos textuales en un corpus consultable.", "Segmento documental", ["Entradas maestras", "Ejemplos", "Comentarios"], ["Corpus indexado", "Consulta por texto", "Exportación tabular"], ["segment_id", "language", "text", "entry_id", "segment_type", "source_page"]),
  ...
  p(4, "base-terminologica-espanol-raramuri", "Base terminológica español-rarámuri", "Datos", "Invertir el índice para consultar equivalentes rarámuri desde términos españoles.", "Equivalencia terminológica", ["Traducciones", "Acepciones"], ["Índice SPA→RRM", "Consulta terminológica", "CSV"], ["term_es", "headword_rrm", "sense_id", "classification", "source_page"]),
  p(5, "base-variantes-graficas", "Base de variantes gráficas", "Datos", "Registrar alternancias ortográficas y relaciones entre formas.", "Relación de variantes", ["Lemas", "Formas entre corchetes", "Remisiones"], ["Pares de variantes", "Patrones de alternancia", "Grafo de formas"], ["variant_id", "form_a", "form_b", "pattern", "entry_id", "evidence"]),
  p(6, "palabras-con-saltillo", "Repositorio de palabras con saltillo", "Corpus", "Indexar formas que contienen saltillo para análisis ortográfico y fonológico.", "Forma con saltillo", ["Lemas", "Ejemplos", "Variantes"], ["Listado normalizado", "Contextos documentales", "CSV"], ["form", "normalized_form", "position", "entry_id", "context", "source_page"]),
