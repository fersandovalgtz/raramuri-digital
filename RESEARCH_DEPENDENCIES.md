...
**RESUELTA: A.** Buschmann aporta análisis histórico token-específico.

## D3. C03

**RESUELTA en el alcance relevante: A.** La pertenencia histórica a la familia `ame` y la continuidad largo/breve están adjudicadas; la frontera `c` permanece abierta fuera de ese alcance.

## D4. C04

### C04-core

**RESUELTA: A.** `Nessé/Nesséameke ↔ nese-/nesame/Neseme`.

### C04-Nisé

**Subrama abierta.** Reabrir sólo con comparación histórica directa o mecanismo específico.
